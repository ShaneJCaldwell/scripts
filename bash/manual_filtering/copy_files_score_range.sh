...
# This script will take a pool of pdb files and the scorefile that they had generated and based upon a value, only copy if the
# model fell within a specific range default lower limit is zero, but could be higher if binning, other things possible.
